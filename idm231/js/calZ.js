...
function calZodiac() {
    ...
    $(document).ready(function() {
        $('main').fadeOut(1500).queue(function(next)
            {
...
function displayZodiac(month, day, age, fName, lName)
{
    ...
    if ((month == 12 && day >= 22) | (month == 1 && day <= 19)) {
        ...
        // main.getElementsByTagName("img")[0].src = "const/bel.svgequ.svg";
        $(document).ready(function()
        {
            $('#zod').attr('src', 'const/equ.svg')
        });
